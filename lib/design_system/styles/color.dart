...
class ColorCollection {
  static const Color primary900 = Color(0xFF212529);
  static const Color primary100 = Color(0xFFf8f9fa);
  static const Color accentRed = Color(0xFFAF2E2E);
  static const Color accentBlue = Color(0xFF2F75BB);
  static const Color accentGreen = Color(0xFF047C48);
